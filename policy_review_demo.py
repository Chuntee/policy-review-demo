...
"""
    ...
    try:
        return eval(output)  # 简化处理为字典
    except:
        return {"products": []}

# --- 页面设定 ---
st.title("🧾 Insurance Policy Review Demo v2")
st.markdown("为保险代理人打造的智能整理工具 💼")

# --- 用户输入区 ---
input_text = st.text_input("请输入客户保单资讯：", placeholder="如：客户有一份SPWM 500千，还有SMM200医疗卡")
